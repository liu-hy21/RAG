...
if __name__ == "__main__":
    ...
    '''
    gold_file_name = '../../../Documents/百度云盘下载位置/证件照、生活照/polyu/自然语言处理/project/data_and_code/data/val.jsonl'
    pred_file_name = '../../../Documents/百度云盘下载位置/证件照、生活照/polyu/自然语言处理/project/data_and_code/data/val_predict.jsonl'
